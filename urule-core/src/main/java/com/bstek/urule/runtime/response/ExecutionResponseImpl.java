...
public class ExecutionResponseImpl implements RuleExecutionResponse, FlowExecutionResponse {
    ...
    private final List<RuleExecutionResponse> ruleExecutionResponses = new ArrayList<RuleExecutionResponse>();
    private final List<FlowExecutionResponse> flowExecutionResponses = new ArrayList<FlowExecutionResponse>();
    private List<RuleInfo> rulesFired;
    private final List<RuleInfo> matchedRules = new ArrayList<RuleInfo>();
