...
public class KnowledgeSessionImpl implements KnowledgeSession {
    ...
    private final List<Object> facts = new ArrayList<Object>();
    private final List<Object> historyFacts = new ArrayList<Object>();
    private final List<KnowledgePackage> knowledgePackageList = new ArrayList<KnowledgePackage>();
    private final List<ReteInstance> reteInstanceList = new ArrayList<ReteInstance>();
    private final Map<String, Object> parameterMap = new HashMap<String, Object>();
    private final List<Map<?, ?>> factMaps = new ArrayList<Map<?, ?>>();
    private final List<KnowledgeEventListener> eventListeners = new ArrayList<KnowledgeEventListener>();
