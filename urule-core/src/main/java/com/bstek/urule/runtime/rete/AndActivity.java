...
public class AndActivity extends JoinActivity {
	private final List<Path> fromPaths = new ArrayList<Path>();
	private boolean pass;
	private FactTracker currentTracker;
	private final Map<Activity, List<Map<String, Object>>> toActivityMap = new HashMap<Activity, List<Map<String, Object>>>();
