...
public class ContextImpl implements Context {
	...
	private final AssertorEvaluator assertorEvaluator;
	private final Map<String, String> variableCategoryMap;
	private final ValueCompute valueCompute;
	private final WorkingMemory workingMemory;
	private final List<MessageItem> debugMessageItems;
	private final ElCalculator elCalculator = new ElCalculator();
