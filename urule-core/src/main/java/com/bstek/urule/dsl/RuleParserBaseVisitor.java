...
public class RuleParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements RuleParserVisitor<T> {
     ...
     */
    @Override
    public T visitExpEval(RuleParserParser.ExpEvalContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitExpAll(RuleParserParser.ExpAllContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitExpExists(RuleParserParser.ExpExistsContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitExpCollect(RuleParserParser.ExpCollectContext ctx) {
        return visitChildren(ctx);
    }
