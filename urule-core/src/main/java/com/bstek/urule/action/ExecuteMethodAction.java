...
public class ExecuteMethodAction extends AbstractAction {
	...
	private final ActionType actionType = ActionType.ExecuteMethod;
	...
	private boolean classMatch(Class<?> clazz, Datatype datatype) {
		...
		switch (datatype) {
			case String:
				match = clazz.equals(String.class);
				break;
			case BigDecimal:
				match = clazz.equals(BigDecimal.class);
				break;
			case Boolean:
				match = clazz.equals(Boolean.class) || clazz.equals(boolean.class);
				break;
			case Date:
				match = clazz.equals(Date.class);
				break;
			case Double:
				match = clazz.equals(Double.class) || clazz.equals(double.class);
				break;
			case Enum:
				match = Enum.class.isAssignableFrom(clazz);
				break;
			case Float:
				match = clazz.equals(Float.class) || clazz.equals(float.class);
				break;
			case Integer:
				match = clazz.equals(Integer.class) || clazz.equals(int.class);
				break;
			case Char:
				match = clazz.equals(Character.class) || clazz.equals(char.class);
				break;
			case List:
				match = List.class.isAssignableFrom(clazz);
				break;
			case Long:
				match = clazz.equals(Long.class) || clazz.equals(long.class);
				break;
			case Map:
				match = Map.class.isAssignableFrom(clazz);
				break;
			case Set:
				match = Set.class.isAssignableFrom(clazz);
				break;
			case Object:
				match = true;
				break;
